  ...
  <div class="modal-dialog" role="document">
   ...
   <div class="col-md-12 btn-print">
               ...
               <option value="miercoles">Miercoles</option>
                <option value="jueves">Mueves</option>
...
?>
      ...
      <td><?php echo $row['cita_duracion'];?></td>
                    ...
                    //  if ($eliminar=="si") {
                      ...
                      ?>
   <a class="small-box-footer btn-print"  href="<?php  echo "../horario_medico/eliminar_horario_medico.php?id_horario_medico=$id_horario_medico&cid=$cid";?>" onClick="return confirm('¿Está seguro de que quieres eliminar horario medico??');"><i class="glyphicon glyphicon-remove" style="color: red;"></i></a>
   <?php
                  //    }
                      ?>
                               <?php
