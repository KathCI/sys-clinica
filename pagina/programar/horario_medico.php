...
<div class="modal fade" id="miModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
   ...
   <div class="col-md-12 btn-print">
                      <div class="form-group">
                        <label for="date" class="col-sm-3 control-label">Día laboral</label>
                        <div class="input-group col-sm-8">
   ...
   <div class="col-md-12 btn-print">
        ...
        <div class="col-md-12 btn-print">
                      <div class="form-group">
                        <label for="date" class="col-sm-3 control-label">Duración de la cita</label>
                        <div class="input-group col-sm-8">
               ...
               <option value="30 minutos">15 minutos</option>
                ...
                <option value="60 minutos">90 minutos</option>
                    ...
                    <div class="col-md-12">
                       <div class="col-md-12">
                        <button class="btn btn-lg btn-success btn-print" id="daterange-btn"  name="">Agregar</button>
...
<form class = "btn btn-white btn-print">
                      Buscar: <input id="txtBusqueda" type="text" onkeyup="Buscar();" />

</form>


                  <div class="box-header btn btn-light" >
                  <h3 class="box-title"> Horarios médicos </h3>
                </div><!-- /.box-header -->
                <div class="box-body ">
...
?>
      ...
      <td><?php echo $row['cita_duracion'];?></td>
                    ...
                    //  if ($eliminar=="si") {
                      ...
                      ?>
   <a class="small-box-footer btn-print"  href="<?php  echo "../programar/eliminar_horario_medico.php?id_horario_medico=$id_horario_medico";?>" onClick="return confirm('¿Está seguro de que quieres eliminar horario medico??');"><i class="glyphicon glyphicon-remove" style="color: red;"></i></a>
   <?php
                  //    }
                      ?>
                               <?php
