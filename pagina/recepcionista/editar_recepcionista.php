...
?>
 ...
 <!--end of modal-->
                  ...
                  <h3 class="box-title"> Editar datos de empleado</h3>
                </div><!-- /.box-header -->
              
              <a class="btn btn-primary btn-print" href="recepcionista.php"    style="height:25%; width:15%; font-size: 12px " role="button">Regresar</a>
