...
?>
 ...
 <!--end of modal-->
                  ...
                  <h3 class="box-title"> Modificar detalle de gastos</h3>
                </div><!-- /.box-header -->
              
              <a class="btn btn-primary btn-print" href="gastos.php"    style="height:25%; width:15%; font-size: 12px " role="button">Regresar</a>
...
?>
  ...
  <div class="row">
       ...
       <div class="row">
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                        <label for="date" >Categoría</label>
