    ...
    <table class="table table-bordered">
     ...
     <h3> Total: <?php echo $granTotal; ?></h3>
                  ...
                  <div class="box-footer">
                    ...
                    <a type="button" href="../paciente/<?php  echo "pago_paciente.php?cid=$cid";?>" class="btn btn-primary">Regresar</a>
            ...
            <div class="col-md-8">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Gestión de pago atención médica</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
...
<div id="suggestions"></div>
 ...
 <br>
 <button type="submit" class="btn btn-success">Finalizar venta de servicio</button> 
        </br>
<br>
