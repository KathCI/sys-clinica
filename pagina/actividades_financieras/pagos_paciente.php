...
?>
                  ...
                  <h3 class="box-title">  Pagos a realizar</h3>
                </div><!-- /.box-header -->
...
<a class="btn btn-success btn-print" href="<?php  echo "../boletas_ventas/generar_boleta.php?id_pedido=$id_pedido";?>"  target="_blank"  role="button">Factura</a>
