...
#buscar{
 ...
 <!--end of modal-->
                ...
                <a class="btn btn-primary btn-print" href="preescripcion_agregar.php"    style="height:25%; width:15%; font-size: 12px " role="button">Registrar preinscripción</a>
...
?>
                  ...
                  <div class="box-header">
                  <h3 class="box-title"> Lista preinscripción</h3>
                </div><!-- /.box-header -->
