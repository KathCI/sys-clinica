...
?>
 ...
 <!--end of modal-->
                  ...
                  <h3 class="box-title"> Agregar un nuevo pago</h3>
                </div><!-- /.box-header -->
                <a class="btn btn-primary btn-print" href="../paciente/paciente.php"    style="height:25%; width:15%; font-size: 12px " role="button">Regresar</a>
                <a class="btn btn-success btn-print" href="../pos_medicina/<?php  echo "pos_medicina.php?cid=$cid";?>"    style="height:25%; width:15%; font-size: 12px " role="button">Agregar</a>   
      <br>           
