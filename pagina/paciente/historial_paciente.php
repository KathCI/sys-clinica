...
<div>
<a class="btn btn-primary btn-print" href="paciente.php"    style="height:25%; width:15%; font-size: 12px " role="button">Regresar</a>
        </div>
                  ...
                  <h3 class="box-title"> Agregar historial clínico</h3>
                </div><!-- /.box-header -->
...
<a class="btn btn-primary btn-print" href="<?php  echo "../paciente/editar_cita.php?id_cita=$id_cita";?>"    role="button">Editar</a>
<a class="btn btn-danger btn-print" href="<?php  echo "../paciente/eliminar_cita.php?id_cita=$id_cita";?>"  onClick="return confirm('¿Está seguro de que quieres eliminar??');"  role="button">Eliminar</a>
      <?php
