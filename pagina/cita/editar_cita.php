...
?>
 ...
 <!--end of modal-->
                  ...
                  <h3 class="box-title"> Editar cita médica</h3>
                </div><!-- /.box-header -->
              
              <a class="btn btn-primary btn-print" href="cita.php"    style="height:25%; width:15%; font-size: 12px " role="button">Regresar</a>
