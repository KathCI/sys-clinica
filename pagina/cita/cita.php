...
#buscar{
 ...
 <!--end of modal-->
                ...
                <a class="btn btn-primary btn-print" href="cita_agregar.php"    style="height:25%; width:15%; font-size: 12px " role="button">Registrar citas médicas</a>
 ...
 <!--end of modal-->
                  ...
                  <div class="box-header">
                  <h3 class="box-title"> Lista de citas agendadas</h3>
                </div><!-- /.box-header -->
...
<a class="btn btn-primary btn-print" href="<?php  echo "../cita/editar_cita.php?id_cita=$id_cita";?>"    role="button">Editar</a>
